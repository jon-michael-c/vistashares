<x-section class="-mb-[2rem]  sm:-mb-[6rem]">
    <div class=" gap-2 sm:gap-6 items-start content-start">
        ...
        <div class="inner-full sm:absolute  sm:w-1/2 sm:right-0 sm:top-[25%] sm:translate-y-[-25%]">
            <img src="@asset('images/motion.svg')" alt="Pure Exposure"
                class="w-full h-full object-cover relative  sm:max-w-[650px] " />
        </div>
