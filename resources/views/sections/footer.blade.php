<footer class="bg-midnight content-grid">
  <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
    <div class="text-center uppercase mb-8 border-t-[1px] border-b-[1px] border-indigo py-8 md:flex md:justify-between">
      <div class="flex flex-col md:flex-row gap-3 md:gap-6 mb-3 md:mb-0">
        <a class="block" href="#">
          Privacy Policy
        </a>
        <a class="block" href="#">
